...
- http://engertlab.fas.harvard.edu/Z-Brain/zDownloads/AnatomyLabelDatabase.hdf5
...
Mask Database
- http://engertlab.fas.harvard.edu/Z-Brain/zDownloads/MaskDatabase.mat
...
In order to create MAP-Maps from pERK and tERK stained data, data must first be registered to the Z-Brain reference brain stack (http://engertlab.fas.harvard.edu/Z-Brain/zDownloads/Ref20131120pt14pl2.nrrd). To do this we use CMTK (https://www.nitrc.org/projects/cmtk/).
